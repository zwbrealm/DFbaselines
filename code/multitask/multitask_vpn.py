...
trainData = np.load("trainData2.npy", allow_pickle=True)
trainlabel = np.load("trainLabel2.npy", allow_pickle=True)
trainlabel_ = np.load("trainLabel_2.npy", allow_pickle=True)
...
testData = np.load("testData2.npy", allow_pickle=True)
testLabel = np.load("testLabel2.npy", allow_pickle=True)
testLabel_ = np.load("testLabel_2.npy", allow_pickle=True)
...
#     # Categorizing Bandwidth
#     if valLabel[i, 0] < 1500:
#         valLabel[i, 0] = 1
#     elif valLabel[i, 0] < 4500:
#         valLabel[i, 0] = 2
#     elif valLabel[i, 0] < 7500:
#         valLabel[i, 0] = 3
#     elif valLabel[i, 0] < 10000:
#         valLabel[i, 0] = 4
#     else:
#         valLabel[i, 0] = 5
#     # Categorizing Duration
#     if valLabel[i, 1] < 1.5:
#         valLabel[i, 1] = 1
#     elif valLabel[i, 1] < 2.5:
#         valLabel[i, 1] = 2
#     elif valLabel[i, 1] < 3.5:
#         valLabel[i, 1] = 3
#     else:
#         valLabel[i, 1] = 4
...
# Y_val1[np.arange(val_size), valLabel[:, 0].astype('int64') - 1] = 1
# Y_val2 = np.zeros((val_size, 4))
# Y_val2[np.arange(val_size), valLabel[:, 1].astype('int64') - 1] = 1
# # matrix2 = np.ones((val_size,25))
# Y_val3 = testLabel_
...
with open('test_log_new2.txt', 'a') as f:
